...
export default function AgentPage({ onBackToHome }: AgentPageProps) {
  ...
  const handleRegisterWhatsApp = (program: string) => {
    const greeting = "Hi AQUIVA GOLD,\n\n";
    const body = `Saya berminat untuk menyertai Program *${program}* AQUIVA GOLD.\n\nBoleh saya tahu cara pendaftaran dan maklumat lanjut?\n\n`;
  ...
  const programs = {
    ...
    stokis: {
      ...
      benefits: [
        ...
        "Rundingan Strategik — Akses bimbingan 1-on-1 terus daripada pihak pengurusan AQUIVA GOLD."
      ],
      requirements: [
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-medium tracking-tight text-charcoal mb-4">
            ...
            <span className="italic font-light text-gold text-2xl sm:text-3xl md:text-4xl block mt-1">AQUIVA GOLD Malaysia</span>
          </h1>
