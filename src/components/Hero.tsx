...
export default function Hero({ onOpenConsultation }: HeroProps) {
  ...
  const heroProducts = [
    { name: "Spray", label: "Penyegar Kulit", img: "/src/assets/images/millenia_spray_1780832166570.png" },
    { name: "Essence", label: "Terapi Mandian", img: "/src/assets/images/millenia_essence_1780832181196.png" },
    { name: "Drop", label: "Suplemen Premium", img: "/src/assets/images/millenia_drop_1780832196488.png" },
  ];
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden bg-ivory" id="hero">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/src/assets/images/aquvia_spa_hero_1780832150912.png"
        ...
        >
          ...
          <div className="relative w-full max-w-sm aspect-square bg-[#EFEAE2]/30 rounded-full border border-stone/40 flex items-center justify-center p-8">
            ...
            <div className="relative w-48 h-48 flex items-center justify-center z-10 transition-transform duration-700 hover:scale-105">
              <img
                src="/src/assets/images/millenia_spray_1780832166570.png"
