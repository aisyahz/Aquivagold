    ...
    <div className="space-y-32 pb-24">
      ...
      <section className="max-w-4xl mx-auto px-6 sm:px-8 space-y-20 text-left">
        ...
        <div className="space-y-5 border-b border-[#EFEAE2] pb-12">
          ...
          <p className="text-[14px] sm:text-[15px] text-[#1F1F1F]/80 leading-[1.8] font-light">
        ...
        <div className="space-y-5 border-b border-[#EFEAE2] pb-12">
          ...
          <div className="bg-[#FAF8F1] border border-[#C8A75B]/25 p-6 sm:p-8 rounded-2xl mt-5 text-[13px] sm:text-[14px] italic text-[#1F1F1F]/70 leading-[1.8] font-semibold">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={idx} className="flex items-start gap-3 bg-[#FAF8F1] p-4 sm:p-5 border border-[#C8A75B]/15 rounded-xl text-[13px] sm:text-[14px] leading-[1.8] text-[#1F1F1F]/80">
      ...
      <section className="max-w-[1400px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16">
        <div className="bg-[#1F1F1F] text-white rounded-[3rem] border border-[#C8A75B]/20 p-10 sm:p-16 text-center space-y-8 max-w-3xl mx-auto shadow-xl">
          ...
          <p className="font-sans text-[13px] sm:text-[14px] text-white/70 max-w-lg mx-auto font-light leading-[1.8]">
