              ...
              >
                <div className="space-y-5">
                  ...
                  <div className="relative w-full aspect-[4/3] rounded-xl border border-[#C8A75B]/20 overflow-hidden bg-stone-50 group-hover:border-[#C8A75B]/50 transition-all duration-500 shadow-xs p-1">
                    ...
                    <div className="absolute inset-3 rounded-lg border border-dashed border-white/20 pointer-events-none group-hover:border-white/40 transition-colors" />
                  </div>
                ...
                <div className="pt-4 border-t border-[#EFEAE2] mt-6 flex items-center justify-between">
                  <button
                    type="button"
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <button 
                    type="button"
                    onClick={() => setSelectedDoc(null)}
                    className="cursor-pointer w-full h-[48px] border-2 border-stone-300 hover:border-black text-stone-700 hover:text-black text-[13px] sm:text-[14px] uppercase tracking-wider font-bold transition-all rounded-lg text-center flex items-center justify-center bg-transparent"
                  >
                    Tutup Semakan
                  </button>
                </div>
