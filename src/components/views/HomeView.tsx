...
export default function HomeView({ onNavigate, onOpenConsultation }: HomeViewProps) {
  ...
  return (
    <div className="space-y-16 lg:space-y-24 pb-20">
      ...
      <div id="hero-wrapper" className="!mt-0 w-full">
        ...
        >
          <div className="max-w-md mx-auto flex flex-col items-center justify-between gap-6 text-center">
            ...
            {/* 2. PRODUCT IMAGE (Visual focus, scaled elegantly to prevent accidentally cropped feel) */}
            <div className="relative w-full h-[32vh] min-h-[190px] max-h-[290px] rounded-xl border border-[#B58D20]/20 overflow-hidden shadow-md" id="hero-mobile-img-container">
              <img 
                src={heroBanner} 
              ...
              <div className="absolute top-2.5 left-2.5 bg-[#1A1A1A]/95 backdrop-blur-md py-1 px-2.5 rounded-full border border-[#B58D20]/40 shadow-sm">
                <span className="text-[9px] uppercase tracking-widest text-[#B58D20] font-extrabold flex items-center gap-1 leading-none">
                  <span className="w-1 h-1 rounded-full bg-[#B58D20] animate-ping" />
                  Luxury Spa Therapy
                </span>
              </div>
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/45 to-transparent h-12 pointer-events-none" />
            </div>
            ...
            {/* 5. CTA BUTTONS (Touch-safe, slightly scaled down for premium feel) */}
            <div className="grid grid-cols-2 gap-3 w-full px-1 pt-1" id="hero-mobile-actions">
              <button
                onClick={() => onNavigate("koleksi")}
                className="cursor-pointer h-[44px] bg-[#B58D20] hover:bg-[#967316] active:scale-95 text-white uppercase tracking-wider font-extrabold text-[11px] transition-all duration-300 rounded-lg flex items-center justify-center gap-1.5 shadow-sm"
              >
                <span>KOLEKSI</span>
                <ArrowRight size={13} />
              </button>
              ...
              <button
                ...
                className="cursor-pointer h-[44px] bg-white hover:bg-[#FAF8F5] active:scale-95 text-[#1A1A1A] border border-[#1A1A1A]/30 uppercase tracking-wider font-extrabold text-[10px] transition-all duration-300 rounded-lg flex items-center justify-center gap-1.5 shadow-sm"
              >
                <MessageSquare size={12} className="text-[#B58D20]" />
      ...
      <section 
        className="hidden md:flex relative min-h-[580px] lg:min-h-[640px] w-full items-center justify-center overflow-hidden border-b border-[#B58D20]/20 pt-12 pb-6 lg:pt-16 lg:pb-8 bg-[#141414]" 
        id="hero-desktop"
        style={{
      ...
      <section className="bg-white py-10 sm:py-14 lg:py-20 border-b border-[#B58D20]/15 max-w-full !mt-0" id="three-steps">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-8 text-center space-y-10">
          <div className="space-y-2.5">
            <span className="text-[11px] sm:text-[11.5px] uppercase tracking-[0.3em] text-[#B58D20] font-bold block">
      ...
      <section className="bg-[#FAF8F5] py-10 sm:py-14 lg:py-20 border-b border-[#B58D20]/15 max-w-full !mt-0" id="spa-therapy">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 lg:gap-10 items-center">
            ...
            <div className="col-span-1 lg:col-span-6">
              <div className="relative w-full aspect-[4/3] lg:aspect-[4/3] rounded-xl border border-[#B58D20]/25 overflow-hidden shadow-lg p-1 bg-white group">
                <img 
                   src={spaImage} 
                  alt="Traditional Malay Herbal Spa & Mandian Tangas Ritual" 
                  className="w-full h-full object-cover rounded-lg transition-transform duration-1000 group-hover:scale-105"
                  referrerPolicy="no-referrer"
                />
      ...
      <section className="bg-white py-10 sm:py-14 lg:py-20 border-y border-[#B58D20]/15 max-w-full" id="why-preview">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-3 mb-10">
            <span className="text-[11px] sm:text-[11.5px] uppercase tracking-[0.3em] text-[#B58D20] font-bold block">REVOLUSI PENJAGAAN DIRI</span>
            <h2 className="text-h2 text-[#1A1A1A]">
      ...
      <section className="max-w-[1280px] mx-auto px-6 sm:px-8 py-10 sm:py-14 lg:py-20" id="collection-preview">
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          <span className="text-[11px] sm:text-[11.5px] uppercase tracking-[0.3em] text-[#B58D20] font-bold block">RANGKAIAN EKSKLUSIF</span>
          <h2 className="text-h2 text-[#1A1A1A]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
           {[
            ...
            <div 
              key={prod.id}
              className="bg-[#FAF8F5] border border-[#B58D20]/20 rounded-xl p-5 sm:p-6 flex flex-col justify-between hover:shadow-lg transition-all duration-300 group"
            >
              <div className="space-y-4">
                {/* Premium Golden Frame with Actual Image & Price Tag */}
                <div className="relative w-full h-[180px] sm:h-[220px] aspect-[4/3] rounded-xl border border-[#B58D20]/20 overflow-hidden shadow-xs group/img hover:border-[#B58D20]/60 transition-all duration-500 bg-white">
                  <img 
                    src={prod.img} 
                    alt={prod.title} 
                    referrerPolicy="no-referrer"
                  ...
                  <div className="absolute inset-2.5 rounded-lg border border-dashed border-white/20 pointer-events-none group-hover/img:border-[#B58D20]/30 transition-colors duration-500" />
                </div>
                ...
                <div className="space-y-2.5 text-left">
                  ...
                  <div className="bg-white border-l-2 border-[#B58D20] p-2.5 rounded-r-lg">
                    <span className="text-[8.5px] uppercase tracking-wider text-[#B58D20] font-extrabold block mb-0.5">Cara Guna:</span>
                    <p className="font-sans text-[11.5px] text-[#1A1A1A] leading-relaxed font-semibold">
                      {prod.usage}
                    </p>
                  </div>

                  <p className="font-sans text-[12.5px] text-[#4A4A4A] leading-relaxed min-h-[36px] font-light">{prod.desc}</p>
                </div>

                {/* Premium Elegant Quantity Selector */}
                <div className="pt-3 border-t border-[#B58D20]/10">
                  <div className="flex items-center justify-between bg-white border border-[#B58D20]/20 p-1.5 rounded-lg">
                    <span className="font-bold text-[10px] tracking-wider uppercase text-stone-500 font-sans pl-1">Kuantiti</span>
                    <div className="flex items-center gap-2.5">
                      <button
                        onClick={() => setQuantity(prod.id, Math.max(1, getQuantity(prod.id) - 1))}
                        className="w-7 h-7 rounded-full border border-[#B58D20]/30 flex items-center justify-center text-[#1A1A1A] hover:bg-[#B58D20] hover:text-white transition-all font-bold text-sm bg-white"
                        title="Kurangkan kuantiti"
                      >
                        -
                      </button>
                      <span className="font-serif text-[13px] font-bold text-[#1A1A1A] w-5 text-center select-none">{getQuantity(prod.id)}</span>
                      <button
              ...
              <div className="pt-3 border-t border-[#B58D20]/15 mt-3 grid grid-cols-2 gap-2.5">
                <a
                  href={getWhatsAppBuyLink(prod.title, prod.price, getQuantity(prod.id))}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="cursor-pointer h-[44px] bg-[#B58D20] hover:bg-[#967316] active:scale-95 text-white text-[11px] uppercase tracking-wider font-extrabold transition-all rounded-lg flex items-center justify-center gap-1 shadow-sm"
                ...
                <button
                  ...
                  className="cursor-pointer h-[44px] bg-white hover:bg-[#FAF8F5] active:scale-95 border border-[#1A1A1A]/30 text-[#1A1A1A] text-[10.5px] uppercase tracking-wider font-extrabold transition-all rounded-lg flex items-center justify-center gap-1 shadow-sm"
        ...
        <div className="text-center mt-12">
          <button
            onClick={() => onNavigate("koleksi")}
            className="cursor-pointer h-[44px] px-6 bg-transparent border-2 border-[#B58D20] text-[#B58D20] hover:bg-[#B58D20] hover:text-white text-[13px] uppercase tracking-wider font-bold transition-all duration-300 rounded-lg inline-flex items-center justify-center"
          >
            Lihat Semua Koleksi
          </button>
        </div>
      ...
      <section className="bg-[#FAF8F5] py-10 sm:py-14 lg:py-20 border-y border-[#B58D20]/20 max-w-full" id="certifications-preview">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
      ...
      <section className="bg-white py-10 sm:py-14 lg:py-20 border-b border-[#B58D20]/15 max-w-full" id="home-therapy-set">
        <div className="max-w-[1280px] mx-auto px-6 sm:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-3 mb-10">
            <span className="text-[11px] sm:text-[11.5px] uppercase tracking-[0.3em] text-[#B58D20] font-bold block font-sans">PAKEJ EKSKLUSIF SPA DI RUMAH</span>
            <h2 className="text-h2 text-[#1A1A1A]">
              Set Terapi Rumah Lengkap &bull; Home Therapy Set
            </h2>
            <p className="text-body text-[#4A4A4A] max-w-xl mx-auto">
              Nikmati amalan mandi tangas herba berprestij bertaraf resort lima bintang secara selamat dan teratur di kediaman peribadi anda.
            </p>
            <div className="w-16 h-[1.5px] bg-[#B58D20] mx-auto mt-2" />
          </div>

          <div className="bg-[#FAF8F5] border border-[#B58D20]/25 rounded-2xl p-5 sm:p-6 lg:p-8 overflow-hidden shadow-xl max-w-4xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
              ...
              <div className="space-y-3">
                <div className="relative aspect-[1.35] rounded-xl overflow-hidden border border-[#B58D20]/20 bg-[#161614] shadow-md flex items-center justify-center p-3">
                  ...
                  <div className="absolute inset-3 rounded-lg border border-dashed border-white/20 pointer-events-none" />
                  
                  <div className="absolute bottom-3 left-3 right-3 text-left space-y-0.5">
                    <span className="text-[9px] uppercase tracking-widest text-[#B58D20] font-extrabold block">PAKEJ KOMPLET</span>
                    <h4 className="font-serif text-white text-base font-bold">Resort Spa Suite Koleksi</h4>
                  </div>
                </div>

                <div className="grid grid-cols-2 gap-1.5">
                  <div className="bg-white border border-[#B58D20]/15 px-2.5 py-1.5 rounded-md text-center shadow-xs">
                    <span className="text-[10px] font-sans font-bold text-[#1A1A1A] block">Kerusi Terapi</span>
                    <span className="text-[8px] text-[#B58D20] font-medium font-mono uppercase">Therapy Chair</span>
                  </div>
                  <div className="bg-white border border-[#B58D20]/15 px-2.5 py-1.5 rounded-md text-center shadow-xs">
                    <span className="text-[10px] font-sans font-bold text-[#1A1A1A] block">Pakaian Belachu</span>
                    <span className="text-[8px] text-[#B58D20] font-medium font-mono uppercase">Spa Apparel</span>
                  </div>
                  <div className="bg-white border border-[#B58D20]/15 px-2.5 py-1 rounded-md text-center shadow-xs">
                    <span className="text-[10px] font-sans font-bold text-[#1A1A1A] block">Steamer 1L</span>
                    <span className="text-[8px] text-[#B58D20] font-medium font-mono uppercase">1L Steam Unit</span>
                  </div>
                  <div className="bg-white border border-[#B58D20]/15 px-2.5 py-1 rounded-md text-center shadow-xs">
                    <span className="text-[10px] font-sans font-bold text-red-700 block">2x BMW Essence</span>
                    <span className="text-[8px] text-red-500 font-extrabold font-mono uppercase animate-pulse">FREE GIFT</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 text-left">
                <div className="space-y-1">
                  <span className="text-[10px] uppercase tracking-widest bg-[#B58D20]/15 text-[#B58D20] font-extrabold px-2 py-0.5 rounded inline-block">
                    PROMOSI PENGENALAN
                  </span>
                  <h3 className="font-serif text-xl font-bold text-[#1A1A1A]">AQUIVA GOLD Home Therapy Set</h3>
                  <p className="font-sans text-[12.5px] sm:text-[13px] text-[#4A4A4A] leading-relaxed font-light">
                ...
                <ul className="space-y-2 font-sans text-[12.5px] text-[#2C2C2C]">
                  <li className="flex items-center gap-2">
                    <span className="w-4 h-4 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center text-[9px] font-bold border border-emerald-100">✔</span>
                  ...
                  <li className="flex items-center gap-2">
                    <span className="w-4 h-4 rounded-full bg-rose-50 text-rose-600 flex items-center justify-center text-[9px] font-bold border border-rose-100">★</span>
                    <span className="text-rose-700"><strong>PERCUMA: 2 Botol BMW Essence Premium</strong></span>
                  </li>
                </ul>

                <div className="bg-white border border-[#B58D20]/20 rounded-xl p-3 flex justify-between items-center shadow-xs">
                  <div>
                    <span className="text-[9.5px] uppercase tracking-wider text-stone-400 block font-bold">Harga Set Lengkap</span>
                    <div className="flex items-baseline gap-1.5">
                      <span className="font-serif text-xl font-black text-[#1A1A1A]">RM 650</span>
                      <span className="text-[10px] text-stone-300 line-through">RM 789.80</span>
                    </div>
                  </div>
                  <span className="text-[8.5px] border border-[#B58D20] text-[#B58D20] uppercase font-bold tracking-widest px-2 py-0.5 rounded-full">
                    Jimat RM139.80
                  </span>
                </div>
                ...
                <div className="pt-1">
                  <div className="flex items-center justify-between bg-white border border-[#B58D20]/20 p-2 rounded-lg shadow-xs">
                    <span className="font-bold text-[10px] tracking-wider uppercase text-stone-500 font-sans pl-1">Kuantiti Set</span>
                    <div className="flex items-center gap-2.5">
                      <button
                      ...
                      <span className="font-serif text-[13px] font-bold text-[#1A1A1A] w-5 text-center select-none">{getQuantity("therapySet")}</span>
                      <button
                        onClick={() => setQuantity("therapySet", getQuantity("therapySet") + 1)}
                        className="w-7 h-7 rounded-full border border-[#B58D20]/30 flex items-center justify-center text-[#1A1A1A] hover:bg-[#B58D20] hover:text-[#1A1A1A] hover:border-[#B58D20] transition-all font-bold text-sm bg-white"
                        title="Tambah kuantiti"
                       >
                        +
                      </button>
                ...
                <div className="grid grid-cols-2 gap-2.5 pt-1">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="cursor-pointer h-[44px] bg-[#B58D20] hover:bg-[#967316] active:scale-95 text-white font-sans text-[11px] uppercase tracking-wider font-extrabold transition-all duration-300 rounded-lg flex items-center justify-center gap-1 shadow-sm"
                  ...
                  <button
                    ...
                    className="cursor-pointer h-[44px] bg-white hover:bg-[#FAF8F5] active:scale-95 border border-[#1A1A1A]/30 text-[#1A1A1A] font-sans text-[11px] uppercase tracking-wider font-extrabold transition-all rounded-lg flex items-center justify-center gap-1 shadow-sm"
      ...
      <section className="max-w-[1280px] mx-auto px-6 sm:px-8 py-10 sm:py-14 lg:py-20 font-sans" id="testimonials-preview">
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-10">
          <span className="text-[11px] sm:text-[11.5px] uppercase tracking-[0.3em] text-[#B58D20] font-bold block">BUKTI SOSIAL</span>
          <h2 className="text-h2 text-[#1A1A1A]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {[
            ...
            <div 
              key={idx}
              className="bg-[#FAF8F5] border border-[#B58D20]/20 rounded-xl p-5 text-left flex flex-col justify-between hover:border-[#B58D20]/45 hover:shadow-md transition-all duration-300 min-h-[190px]"
            >
              <p className="font-sans text-[13px] italic text-[#1A1A1A]/85 leading-relaxed">
                {item.text}
              </p>
              
              <div className="pt-3.5 border-t border-[#B58D20]/15 mt-3.5 flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-[#1A1A1A] to-[#B58D20] flex items-center justify-center text-white text-[11px] font-bold shadow">
                  {item.author[0]}
                </div>
                <div>
                  <h4 className="font-serif text-[13px] sm:text-[14px] font-bold text-[#1A1A1A]">{item.author}</h4>
                  <span className="text-[9.5px] sm:text-[10px] text-[#B58D20] font-semibold block leading-none mt-1">{item.role} &bull; {item.location}</span>
                </div>
              </div>
            </div>
          ))}
      ...
      <section 
        className="relative text-white py-16 md:py-20 border-y border-[#B58D20]/20 max-w-full overflow-hidden bg-cover bg-center bg-no-repeat" 
        ...
        <div className="max-w-[1280px] mx-auto px-6 sm:px-8 text-center lg:text-left relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
            ...
            <div className="lg:col-span-8 space-y-3.5">
              <span className="text-[11px] sm:text-[11.5px] uppercase tracking-[0.3em] text-[#B58D20] font-bold block animate-none">PROGRAM RAKAN NIAGA</span>
              <h2 className="text-h2 text-white font-medium tracking-tight">
                Jana Pendapatan Bersama AQUIVA GOLD
              </h2>
              <p className="font-sans text-[13px] sm:text-[13.5px] text-white/85 max-w-3xl leading-relaxed">
            ...
            <div className="lg:col-span-4 flex justify-center lg:justify-end">
              <button
                ...
                className="cursor-pointer w-full sm:w-auto h-[46px] sm:h-[50px] px-8 bg-[#B58D20] hover:bg-[#967316] text-white text-[13.5px] uppercase tracking-wider font-bold transition-all duration-300 rounded-md shadow-lg flex items-center justify-center animate-none"
              >
                Sertai Sekarang
              </button>
            </div>
      ...
      <section className="max-w-[1280px] mx-auto px-6 sm:px-8 py-10 sm:py-14 lg:py-20" id="final-cta">
        <div className="bg-[#FAF8F5] border border-[#B58D20]/25 rounded-2xl p-6 sm:p-10 md:p-12 text-center space-y-6 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#B58D20]/5 rounded-full filter blur-xl pointer-events-none" />
          
          <div className="max-w-3xl mx-auto space-y-2.5">
            <span className="text-[11px] sm:text-[11.5px] uppercase tracking-[0.3em] text-[#B58D20] font-bold block font-sans">CADANGAN TERPERINCI</span>
            <h2 className="text-h2 text-[#1A1A1A]">
              Perlukan Konsultasi?
            </h2>
            <div className="w-16 h-[1.5px] bg-[#B58D20] mx-auto mt-2.5" />
            <p className="font-sans text-[13px] sm:text-[13.5px] text-[#4A4A4A] leading-relaxed font-light max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 max-w-lg mx-auto pt-2">
            ...
            <button
              onClick={() => onOpenConsultation("consult")}
              className="cursor-pointer w-full sm:w-auto h-[46px] sm:h-[50px] px-8 bg-white hover:bg-[#FAF8F5] border-2 border-[#B58D20]/40 text-[#1A1A1A] hover:text-[#B58D20] text-[13.5px] sm:text-[14px] uppercase tracking-wider font-bold transition-all rounded-md shadow-xs flex items-center justify-center animate-none"
            >
              Hubungi Kami
            </button>
          </div>
